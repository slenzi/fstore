...
import org.lenzi.fstore.main.config.AclSecurityConfig;
...
/**
 * Spring ACL setup used by postgres-based unit test
 * 
 * @author slenzi
 */
@Configuration
public class TestConfigPostgresSpringACL {
	...
	// in our TestConfigPostgresPersistence.class for JPA & Hibernate.
	@Autowired
