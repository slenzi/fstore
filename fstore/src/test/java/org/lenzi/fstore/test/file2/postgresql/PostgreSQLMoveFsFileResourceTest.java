...
import org.lenzi.fstore.test.file2.AbstractMoveFsFileResource;
...
public class PostgreSQLMoveFsFileResourceTest extends AbstractMoveFsFileResource {
	 ...
	 * 
	 */
	public PostgreSQLMoveFsFileResourceTest() {
	...
	public String getTestStorePath() {
		...
		//return "/Users/slenzi/Programming/file_store/sample_resource_store_move_file";
		return getProperty("test.store.test_move_file");
	}
