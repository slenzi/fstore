...
public abstract class AbstractMoveFile extends AbstractTreeTest {
	...
	public void doMoveFile() throws Exception {
		...
		String dirPath3 = fileStoreManager.getAbsoluteDirectoryString(fileStore, movedEntry.getDirectory());
		String fullFilePath3 = fileStoreManager.getAbsoluteFileString(fileStore, movedEntry.getDirectory(), movedEntry);
		...
		// check that file has been moved to dir 3
		dirPath3 = fileStoreManager.getAbsoluteDirectoryString(fileStore, movedEntry.getDirectory());
		fullFilePath3 = fileStoreManager.getAbsoluteFileString(fileStore, movedEntry.getDirectory(), movedEntry);
		assertNotNull(dirPath3);
		logger.info("Path of 3 => " + dirPath3);
