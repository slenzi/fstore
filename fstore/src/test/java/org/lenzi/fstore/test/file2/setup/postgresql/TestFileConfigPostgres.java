 ...
 * 
 */
package org.lenzi.fstore.test.file2.setup.postgresql;
...
import org.lenzi.fstore.test.core.setup.postgresql.TestCoreConfigPostgresPersistence;
...
public class TestFileConfigPostgres extends AbstractWebSocketMessageBrokerConfigurer {

	@InjectLogger
	private Logger logger;	
	
	public TestFileConfigPostgres() {
