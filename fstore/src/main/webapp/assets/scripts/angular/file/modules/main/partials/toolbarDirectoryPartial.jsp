...
<md-toolbar class="md-toolbar-tools">
	...
	<md-button class="" ng-click="main.handleEventSwitchResourceView()" aria-label="Toggle Resource View">
		<md-icon ng-if="main.isUsingIconView()" md-svg-icon="<%=request.getContextPath()%>/common/assets/img/icons/ic_view_list_24px.svg"></md-icon>
		<md-icon ng-if="!main.isUsingIconView()" md-svg-icon="<%=request.getContextPath()%>/common/assets/img/icons/ic_view_module_24px.svg"></md-icon>
	</md-button>	
