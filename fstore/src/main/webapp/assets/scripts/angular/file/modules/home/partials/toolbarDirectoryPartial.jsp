...
<md-toolbar class="md-toolbar-tools">
	...
	<md-button class="" ng-click="home.handleEventSwitchResourceView()" aria-label="Toggle Resource View">
		<md-icon ng-if="home.isUsingIconView()" md-svg-icon="<%=request.getContextPath()%>/file/assets/img/icons/ic_view_list_24px.svg"></md-icon>
		<md-icon ng-if="!home.isUsingIconView()" md-svg-icon="<%=request.getContextPath()%>/file/assets/img/icons/ic_view_module_24px.svg"></md-icon>
	</md-button>	
