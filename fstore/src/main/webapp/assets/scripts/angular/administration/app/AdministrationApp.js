(function(){
	...
	/**
	 * Initialize app with 'angular material' and our 'fstoreAdministrationMain' module
	 *
	 ...
	 * fstoreAdministrationMain - Our main system settings module
	 ...
	 */
	administrationApp = angular
		.module('fstoreAdministration',
				[
				 'ui.router', 'ngMaterial', 'ngResource', 'fstoreAdministrationMain', 'fstore-models-module', 
		...
		function materialConfig($mdThemingProvider){
			...
			// Extend the red theme with a few different shades
			var adminRed = $mdThemingProvider.extendPalette('red', {
				'50':  'ff1a1a',
				'200': 'cc0000',
				'400': '800000',
				'800': '660000'
			...
			// Register the new color palette map with the name <code>admin-red</code>
			$mdThemingProvider.definePalette('admin-red', adminRed);				
	
			// apply our admin-red theme
			$mdThemingProvider.theme('default')
				.primaryPalette('admin-red', {
					'default': '50', // by default use shade 50 from the red palette for primary intentions
		...
		function uiRouteConfig(appConstants, $stateProvider, $urlRouterProvider){
			...
			// For any unmatched url, redirect to /home state. This partial shows a list of all resource stores.
			...
			$stateProvider
				.state('main_home', {
					...
					views: {
						'mainContent': {
							templateUrl: appConstants.contextPath + '/assets/scripts/angular/administration/modules/main/partials/homePartial.jsp'
						},
						'toolbarContent': {
							templateUrl: appConstants.contextPath + '/assets/scripts/angular/administration/modules/main/partials/toolbarHomePartial.jsp'							
						}
					}
				});
