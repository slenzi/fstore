...
<html lang="en" >
	...
	<head>
    	...
    	<title>FStore: Administration</title>
	    ...
	    <!-- override common styles with administration specific styles -->
	    <link rel="stylesheet" href="<%=request.getContextPath()%>/administration/assets/css/app.css"/>
	...
	<body ng-app="fstoreAdministration" layout="row" ng-controller="mainController as main">
		...
		<md-content layout="column" style="display: flex; flex-flow: column; height: 100%;">
			...
			<md-content layout="column" class="md-hue-1" style="padding-top: 0px;">
				...
				<md-toolbar class="md-toolbar-tools md-hue-1">
					...
					<span style="font-style: italic; whitespace:nowrap;">Admin Right Nav</a>
