...
/**
 * Code for maintaining tree structures within a database.
 * 
...
@Repository
@Transactional
public class ClosureRepository extends AbstractRepository {
	 ...
	 */
	public FSNode addNode(Long parentNodeId, String name){
	 ...
	 * @param dateUpdated
	 */
	private FSNode reAddNode(Long nodeId, Long parentNodeId, String name, Timestamp dateCreated, Timestamp dateUpdated){
	 ...
	 */
	private void removeNode(Long nodeId, boolean nodeTable, boolean pruneTable){
	 ...
	 */
	public void removeChildren(long nodeId){
	 ...
	 */
	private void reAddTree(FSNode rootNode, Long newParentId, List<FSNode> childNodes, HashMap<Long,List<FSNode>> treeMap, Timestamp dateUpdated){
