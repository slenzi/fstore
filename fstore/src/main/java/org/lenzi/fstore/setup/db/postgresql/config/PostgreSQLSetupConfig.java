...
/**
 * Persistence config used for setting up the PostgreSQL database.
 * 
 * @author sal
 */
@Configuration
...
@Import({
	PostgreSQLSetupPropertyConfig.class
})
public class PostgreSQLSetupConfig {

	private Logger logger = LoggerFactory.getLogger(PostgreSQLSetupConfig.class);
	
	@Autowired
	private PostgreSQLSetupProperties setupProps;
