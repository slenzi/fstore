...
drop sequence TEST.FS_UPLD_LOG_ID_SEQUENCE 
drop sequence TEST.FS_UPLD_LOG_RES_ID_SEQUENCE
...
drop table TEST.FS_UPLOAD_LOG;
drop table TEST.FS_UPLOAD_LOG_RESOURCE;
drop table TEST.FS_UPLOAD_LOG_RESOURCE_LINK;
 ...
 */
create table TEST.FS_UPLOAD_LOG ( 
